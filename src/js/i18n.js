/**
 * ChroniCaree Landing Page - Internationalization (i18n) System
 * Handles language switching and text translation functionality
 */

class ChroniCareeI18n {
    constructor() {
        this.currentLanguage = localStorage.getItem('chronicaree-language') || 'es';
        this.translations = {};
    ...
    async init() {
        try {
            ...
            console.log(`🌍 ChroniCaree i18n initialized with language: ${this.currentLanguage}`);
        } catch (error) {
    ...
    getFallbackTranslations() {
        return {
            ...
            hero: {
                title: "Transformando el cuidado de enfermedades crónicas desde casa",
                subtitle: "Una plataforma digital que simplifica el seguimiento, mejora la adherencia al tratamiento y previene complicaciones antes de que ocurran",
                btnPrimary: "Explorar Soluciones",
    ...
    async updatePageLanguage(lang) {
        try {
            ...
            localStorage.setItem('chronicaree-language', lang);
            this.currentLanguage = lang;

            // Dispatch custom event for other components
            document.dispatchEvent(new CustomEvent('chronicaree:languageChanged', {
...
window.chronicareeI18n = new ChroniCareeI18n();

// Export for module systems
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ChroniCareeI18n;
}
